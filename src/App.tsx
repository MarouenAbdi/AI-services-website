...
const services = [
  ...
  },
  {
    ...
    longDescription: "Enhance your CRM capabilities with AI-powered integrations. Our solution connects with your existing CRM system to automate data entry, provide predictive analytics, and generate actionable insights. This leads to better customer relationship management and increased sales efficiency.",
  ...
  },
  {
    ...
    longDescription: "Get custom AI solutions designed specifically for your business needs. Whether it's process automation, predictive analytics, or specialized AI models, we create tailored solutions that integrate seamlessly with your existing workflows and drive real business value.",
  ...
  },
  {
    ...
    longDescription: "Benefit from expert guidance on implementing AI in your business. Our consultation services help you identify opportunities for AI adoption, develop implementation strategies, and ensure successful deployment. We provide ongoing support to maximize the value of your AI investments.",
...
const testimonials = [
  {
    quote: "The AI solutions provided by this team have transformed our customer service operations. We've seen a 60% reduction in response times and significantly improved customer satisfaction scores.",
    author: "Sarah Chen",
    role: "CTO",
    company: "TechForward"
  },
  {
    quote: "Implementing their AI chat agents has been a game-changer for our business. The seamless integration and powerful capabilities have exceeded our expectations.",
    author: "Michael Rodriguez",
    role: "Head of Innovation",
    company: "Future Dynamics"
  },
  {
    quote: "The level of expertise and support we received during our AI transformation journey was exceptional. Their solutions have given us a competitive edge in our market.",
    author: "Emily Watson",
    role: "Operations Director",
    company: "Global Solutions Inc"
  },
  {
    quote: "The custom AI solutions developed for our specific needs have revolutionized our workflow. The attention to detail and understanding of our business requirements was impressive.",
    author: "David Park",
    role: "CEO",
    company: "InnovateAI"
  },
  {
    quote: "Their AI consultation services provided invaluable insights that helped us navigate our digital transformation. The ROI has been remarkable.",
...
const blogPosts = [
  {
    ...
    excerpt: "Discover how artificial intelligence is revolutionizing customer service and what it means for businesses in 2025 and beyond.",
  ...
  },
  {
    ...
    excerpt: "Learn how businesses are leveraging AI to identify and qualify leads more effectively, resulting in higher conversion rates.",
    image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80",
    date: "March 10, 2025",
    content: "Full blog post content here..."
  },
  {
    ...
    excerpt: "Explore the latest developments in voice AI technology and how it's transforming business communications.",
    image: "https://images.unsplash.com/photo-1589254065878-42c9da997008?auto=format&fit=crop&q=80",
    date: "March 5, 2025",
    content: "Full blog post content here..."
  }
